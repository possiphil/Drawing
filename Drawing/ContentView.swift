...
//  Drawing
//
//  Created by Philipp Sanktjohanser on 17.12.22.
//
...
struct Arrow: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addRect(CGRect(x: rect.midX - (lineWidth / 2), y: rect.height / 3, width: lineWidth, height: rect.height / 2))
...
struct ContentView: View {
    ...
    var body: some View {
        VStack(spacing: 32) {
            ...
            Text("Steps: \(steps)")
            Slider(value: $steps, in: 10...1000, step: 10)
                .padding(.horizontal)
        }
    }
}
